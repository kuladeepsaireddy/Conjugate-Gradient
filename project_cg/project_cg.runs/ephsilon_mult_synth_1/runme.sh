...
HD_PWD='D:/mygit/CG_Project/project_cg/project_cg.runs/ephsilon_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ephsilon_mult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ephsilon_mult.tcl
