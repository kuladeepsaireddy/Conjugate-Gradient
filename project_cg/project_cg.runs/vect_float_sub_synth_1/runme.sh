...
HD_PWD='D:/mygit/CG_Project/project_cg/project_cg.runs/vect_float_sub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vect_float_sub.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vect_float_sub.tcl
