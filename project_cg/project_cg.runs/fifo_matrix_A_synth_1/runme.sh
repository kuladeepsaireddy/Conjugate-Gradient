...
HD_PWD='D:/mygit/CG_Project/project_cg/project_cg.runs/fifo_matrix_A_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_matrix_A.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_matrix_A.tcl
