...
HD_PWD='D:/mygit/CG_Project/project_cg/project_cg.runs/scalar_float_division_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scalar_float_division.vds -m64 -mode batch -messageDb vivado.pb -notrace -source scalar_float_division.tcl
