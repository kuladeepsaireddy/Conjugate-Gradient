...
HD_PWD='D:/mygit/CG_Project/project_cg/project_cg.runs/floating_point_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source floating_point_0.tcl
