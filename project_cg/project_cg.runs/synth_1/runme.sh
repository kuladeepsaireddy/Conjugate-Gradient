...
HD_PWD='D:/mygit/CG_Project/project_cg/project_cg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vector_by_vector.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vector_by_vector.tcl
