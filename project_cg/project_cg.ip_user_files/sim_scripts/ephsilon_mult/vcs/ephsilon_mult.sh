...
# executing this script. Please type 'ephsilon_mult.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key ephsilon_mult_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc ephsilon_mult_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../project_cg.srcs/sources_1/ip/ephsilon_mult/sim/ephsilon_mult.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.ephsilon_mult -o ephsilon_mult_simv
}
...
simulate()
{
  ...
  ./ephsilon_mult_simv $opts -do simulate.do
}
# Script usage
usage()
{
