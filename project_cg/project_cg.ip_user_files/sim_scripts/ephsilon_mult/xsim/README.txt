...
#
# Generated by export_simulation on Mon Jun 19 11:20:57 +0530 2017
#
################################################################################
...
switch to the './ephsilon_mult.sh' script.

./ephsilon_mult.sh -reset_run
...
./ephsilon_mult.sh -noclean_files

For more information on the script, please type './ephsilon_mult.sh -help'.
