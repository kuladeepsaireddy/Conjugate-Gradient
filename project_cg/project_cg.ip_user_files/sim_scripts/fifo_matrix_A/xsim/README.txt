...
#
# Generated by export_simulation on Wed Jun 28 16:29:15 +0530 2017
#
################################################################################
...
switch to the './fifo_matrix_A.sh' script.

./fifo_matrix_A.sh -reset_run
...
./fifo_matrix_A.sh -noclean_files

For more information on the script, please type './fifo_matrix_A.sh -help'.
