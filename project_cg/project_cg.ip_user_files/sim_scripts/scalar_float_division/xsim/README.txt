...
#
# Generated by export_simulation on Wed Jun 14 14:44:33 +0530 2017
#
################################################################################
...
switch to the './scalar_float_division.sh' script.

./scalar_float_division.sh -reset_run
...
./scalar_float_division.sh -noclean_files

For more information on the script, please type './scalar_float_division.sh -help'.
