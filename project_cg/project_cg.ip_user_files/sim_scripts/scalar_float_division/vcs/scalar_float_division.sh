...
#
# Filename    : scalar_float_division.sh
...
#
# Generated by Vivado on Wed Jun 14 14:44:33 +0530 2017
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: scalar_float_division.sh [-help]
# usage: scalar_float_division.sh [-lib_map_path]
# usage: scalar_float_division.sh [-noclean_files]
# usage: scalar_float_division.sh [-reset_run]
#
...
# executing this script. Please type 'scalar_float_division.sh -help' for more information.
#
...
# Script info
echo -e "scalar_float_division.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: scalar_float_division.sh [-help]\n\
Usage: scalar_float_division.sh [-lib_map_path]\n\
Usage: scalar_float_division.sh [-reset_run]\n\
Usage: scalar_float_division.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./scalar_float_division.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./scalar_float_division.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key scalar_float_division_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc scalar_float_division_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../project_cg.srcs/sources_1/ip/scalar_float_division/sim/scalar_float_division.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.scalar_float_division -o scalar_float_division_simv
}
...
simulate()
{
  ...
  ./scalar_float_division_simv $opts -do simulate.do
}
# Script usage
usage()
{
