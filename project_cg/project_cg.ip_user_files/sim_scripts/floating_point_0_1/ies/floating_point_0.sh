...
#
# Generated by Vivado on Mon Jun 12 14:40:14 +0530 2017
...
# Script info
echo -e "floating_point_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./floating_point_0.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../project_cg.srcs/sources_1/ip/floating_point_0_1/sim/floating_point_0.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.floating_point_0 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.floating_point_0 -input simulate.do
}
# Script usage
usage()
{
