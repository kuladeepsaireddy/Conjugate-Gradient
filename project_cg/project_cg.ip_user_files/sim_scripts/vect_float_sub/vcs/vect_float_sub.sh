...
#
# Generated by Vivado on Wed Jun 14 14:27:09 +0530 2017
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: vect_float_sub.sh [-help]
# usage: vect_float_sub.sh [-lib_map_path]
# usage: vect_float_sub.sh [-noclean_files]
# usage: vect_float_sub.sh [-reset_run]
#
...
# executing this script. Please type 'vect_float_sub.sh -help' for more information.
#
...
# Script info
echo -e "vect_float_sub.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: vect_float_sub.sh [-help]\n\
Usage: vect_float_sub.sh [-lib_map_path]\n\
Usage: vect_float_sub.sh [-reset_run]\n\
Usage: vect_float_sub.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./vect_float_sub.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./vect_float_sub.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key vect_float_sub_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc vect_float_sub_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../project_cg.srcs/sources_1/ip/vect_float_sub/sim/vect_float_sub.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.vect_float_sub -o vect_float_sub_simv
}
...
simulate()
{
  ...
  ./vect_float_sub_simv $opts -do simulate.do
}
# Script usage
usage()
{
