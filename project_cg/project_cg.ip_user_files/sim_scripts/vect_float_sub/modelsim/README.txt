...
#
# Generated by export_simulation on Wed Jun 14 14:27:09 +0530 2017
#
################################################################################
...
switch to the './vect_float_sub.sh' script.

./vect_float_sub.sh -reset_run
...
./vect_float_sub.sh -noclean_files

For more information on the script, please type './vect_float_sub.sh -help'.
